...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey, "Control", "Shift" }, "l", function () awful.util.spawn("xlock -mode blank") end),
    ...
    awful.key({ modkey, "Shift"   }, "l",     function ()
                                                 ...
                                                 -- master window
                                                 if awful.tag.getnmaster() > 1 then
...
-- Start floating clients centered
client.add_signal("manage", function (c, p, startup) awful.placement.centered(c, p) end)
-- }}}
